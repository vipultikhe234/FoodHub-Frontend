    ...
    return (
        <div className="space-y-8 pb-20 font-sans">
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <button 
                        ...
                        className="p-2.5 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-none text-zinc-500 hover:text-zinc-900 dark:hover:text-white transition-all shadow-sm"
                    >
                         <RefreshCw size={18} className={syncing ? 'animate-spin' : ''} />
                    </button>
                    <div className="bg-zinc-900 dark:bg-emerald-500 text-white px-5 py-2.5 rounded-none font-bold text-[10px] uppercase tracking-[0.2em] shadow-lg">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="bg-white dark:bg-zinc-900 p-6 rounded-none border border-zinc-100 dark:border-zinc-800 shadow-sm flex items-center justify-between">
                    <div>
                    ...
                    <div className="w-12 h-12 bg-emerald-50 dark:bg-emerald-900/10 rounded-none flex items-center justify-center text-emerald-500"><Bike size={24} /></div>
                </div>
                <div className="bg-white dark:bg-zinc-900 p-6 rounded-none border border-zinc-100 dark:border-zinc-800 shadow-sm flex items-center justify-between">
                    <div>
                    ...
                    <div className="w-12 h-12 bg-blue-50 dark:bg-blue-900/10 rounded-none flex items-center justify-center text-blue-500"><Navigation size={24} /></div>
                </div>
                <div className="bg-white dark:bg-zinc-900 p-6 rounded-none border border-zinc-100 dark:border-zinc-800 shadow-sm flex items-center justify-between">
                    <div>
                    ...
                    <div className="w-12 h-12 bg-red-50 dark:bg-red-900/10 rounded-none flex items-center justify-center text-red-500"><AlertCircle size={24} /></div>
                </div>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-4 gap-8">
                <div className="lg:col-span-3 h-[600px] bg-white dark:bg-zinc-900 rounded-none border border-zinc-100 dark:border-zinc-800 shadow-xl relative overflow-hidden">
                    {loading ? (
                        ...
                        <>
                            ...
                            <div className="absolute top-6 left-6 z-[1000] bg-white/90 dark:bg-zinc-900/90 backdrop-blur-xl border border-zinc-100 dark:border-zinc-800 px-6 py-4 rounded-none shadow-2xl">
                                <div className="flex items-center gap-3">
                                     <div className="w-10 h-10 bg-zinc-900 dark:bg-emerald-500 rounded-none flex items-center justify-center text-white"><Package size={18} /></div>
                                     <div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        {loading ? (
                            ...
                            riders.map(rider => (
                                <div key={rider.id} className="bg-white dark:bg-zinc-900 p-5 rounded-none border border-zinc-100 dark:border-zinc-800 shadow-sm flex items-center gap-4 group hover:border-emerald-500/50 transition-all">
                                    <div className="w-12 h-12 bg-zinc-50 dark:bg-zinc-800 rounded-none flex items-center justify-center text-zinc-300 group-hover:text-emerald-500 transition-colors">
                                        <Bike size={20} />
                                    </div>
